(function () {
	...
	// Features: fullscreen, selectable
	const isFeatureEnabled = function (feature) {
		return searchParams.get(feature) !== "false";
	};
	// Extra features (disabled by default): exiva
	const isExtraFeatureEnabled = function (feature) {
	...
	TibiaMap.prototype.init = function () {
		...
		if (isExtraFeatureEnabled("exiva")) {
